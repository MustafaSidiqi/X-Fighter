...
HD_PWD='C:/Users/Mustafa/Desktop/WORKING_0.1/Projects/hdmi_in/proj/hdmi_in.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_in_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hdmi_in_wrapper.tcl
