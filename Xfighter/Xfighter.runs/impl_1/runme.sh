...
HD_PWD='C:/Users/Mustafa/Desktop/WORKING_0.1/Projects/hdmi_in/proj/hdmi_in.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_in_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source hdmi_in_wrapper.tcl -notrace
