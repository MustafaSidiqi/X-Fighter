...
HD_PWD='C:/Users/Mustafa/Desktop/sd_card22/sd_card22.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sd_card_design_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sd_card_design_wrapper.tcl
