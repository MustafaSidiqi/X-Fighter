...
HD_PWD='C:/Users/Mustafa/Desktop/sd_card22/sd_card22.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sd_card_design_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source sd_card_design_wrapper.tcl -notrace
