...
--Command     : generate_target sd_card_design_wrapper.bd
--Design      : sd_card_design_wrapper
...
entity sd_card_design_wrapper is
  port (
...
end sd_card_design_wrapper;

architecture STRUCTURE of sd_card_design_wrapper is
  component sd_card_design is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
sd_card_design_i: component sd_card_design
     port map (
